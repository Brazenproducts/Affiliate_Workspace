...
const stores = [
  { name: 'Bartact', domain: 'bartact.myshopify.com', token: 'REDACTED_SHOPIFY_ACCESS_TOKEN' },
  { name: 'Bull Strap', domain: 'bull-strap-78.myshopify.com', token: 'REDACTED_SHOPIFY_ACCESS_TOKEN' },
  { name: 'HSP Off Road', domain: 'hsp-off-road.myshopify.com', token: 'REDACTED_SHOPIFY_ACCESS_TOKEN' },
  { name: 'Brazen Auto', domain: 'brazen-auto.myshopify.com', token: 'REDACTED_SHOPIFY_ACCESS_TOKEN' },
];
