#!/usr/bin/env node
// bartact-content-expand.js
// Expands COULD_BE_DEEPER collection pages to 600+ words via Shopify API
// Targeted to Bartact's brand: Cordura fabric, Made in USA, tactical/off-road gear
...
const collections = [
  {
    ...
    kw: 'jeep wrangler jl seat covers',
    title: 'Jeep Wrangler JL Seat Covers',
    type: 'custom',
  },
  {
    id: '275721355307',
    handle: 'toyota-tacoma-seat-covers',
    kw: 'toyota tacoma seat covers',
    title: 'Toyota Tacoma Seat Covers',
    type: 'smart',
  },
  {
    id: '688348856363',
    handle: 'jeep-wrangler-grab-handles',
    kw: 'jeep wrangler grab handles',
    title: 'Jeep Wrangler Grab Handles',
    type: 'custom',
  },
  {
    id: '137429778455',
    handle: 'molle-accessories',
    kw: 'molle seat covers',
    title: 'MOLLE Accessories',
    type: 'custom',
  },
  {
    id: '688907485227',
    handle: 'fire-extinguisher-holders',
    kw: 'jeep fire extinguisher mount',
    title: 'Fire Extinguisher Holders',
    type: 'custom',
  },
  {
    id: '688526360619',
    handle: 'roll-bar-fire-extinguisher-holder',
    kw: 'roll bar fire extinguisher',
    title: 'Roll Bar Fire Extinguisher Holder',
    type: 'custom',
  },
  {
    id: '684493013035',
    handle: 'jeep-wrangler-storage-bags-organizers',
    kw: 'jeep storage bags',
    title: 'Jeep Wrangler Storage Bags & Organizers',
    type: 'custom',
  },
  {
    id: '688526786603',
    handle: 'ford-bronco-storage-bags',
    kw: 'ford bronco storage',
    title: 'Ford Bronco Storage Bags',
    type: 'custom',
  },
  {
    id: '137430564887',
  ...
  {
    id: '688526458923',
    handle: 'jeep-wrangler-suspension-limit-straps',
    kw: 'jeep limit straps',
    title: 'Jeep Wrangler Suspension Limit Straps',
    type: 'smart',
  },
];

const contentMap = {
  'jeep-wrangler-jl-seat-covers': `<p><strong>Jeep Wrangler JL seat covers</strong> from Bartact are purpose-built for the 2018+ JL platform—precise fitment, zero compromise. Every cover is hand-sewn in the USA from military-spec 1000D Cordura nylon, the same fabric trusted by the US Armed Forces for its abrasion resistance, UV stability, and waterproof performance. Cordura outlasts neoprene and faux-leather alternatives by years, not months.</p>
...
<ul>
  <li><a href="/collections/jeep-wrangler-jk-seat-covers">Jeep Wrangler JK Seat Covers</a></li>
  <li><a href="/collections/jeep-gladiator-seat-covers">Jeep Gladiator Seat Covers</a></li>
...
<ul>
  ...
  'fire-extinguisher-holders': `<p>A <strong>jeep fire extinguisher mount</strong> from Bartact keeps your safety gear within reach—not buried under gear or rolling around the cargo area. Every Bartact fire extinguisher holder is hand-sewn in Gainesville, Georgia from 1000D Cordura, securely mounting standard 1-lb and 2.5-lb extinguishers in a MOLLE-compatible, quick-release design.</p>

<p>Off-road fires can start fast—a fuel line nick on a hot exhaust, a wheel bearing failure, electrical arcing on the trail. Having your extinguisher mounted at a fixed, known location—not buried in your gear pile—can be the difference between a small incident and a total loss.</p>

<h2>Cordura Mount vs. Plastic Bracket</h2>
<ul>
  <li><strong>Fabric won't rattle:</strong> Cordura sleeves damp vibration that causes plastic brackets to crack and rattle on rough trails.</li>
  <li><strong>Quick-release Velcro + strap:</strong> Bartact holders use a dual-retention system—secure on bumps, fast to release in an emergency.</li>
  <li><strong>MOLLE compatible:</strong> Attach to any MOLLE panel—seat back, roll bar mount, cargo area—wherever makes sense for your build.</li>
  <li><strong>Made in USA:</strong> 100% made in Gainesville, Georgia. No imported hardware, no overseas assembly.</li>
</ul>

<h2>Fits Standard Extinguisher Sizes</h2>
<p>Bartact fire extinguisher holders are available for 1-lb (Amerex B385, Kidde Pro 1), 2.5-lb, and 5-lb extinguishers. Roll bar–specific mounts are also available for a clean, dedicated installation.</p>

<h2>Frequently Asked Questions</h2>
<dl>
  <dt><strong>What extinguisher brands fit Bartact holders?</strong></dt>
  <dd>Holders are sized to fit standard diameter extinguishers including Amerex, Kidde, and Badger brands. Check the product listing for specific diameter compatibility.</dd>
  <dt><strong>Can I mount this to my roll bar?</strong></dt>
  <dd>Yes. Bartact makes dedicated roll bar fire extinguisher holders with bolt-on clamps for JK, JL, and Bronco roll bars.</dd>
  <dt><strong>Is the extinguisher secure on aggressive trails?</strong></dt>
  <dd>Absolutely. The dual-retention system (Velcro + cinch strap) keeps the extinguisher locked in place on moguls, rock crawls, and high-speed dirt roads.</dd>
  <dt><strong>Does this work without a MOLLE panel?</strong></dt>
  <dd>Some Bartact holders include a standalone bracket for direct seat-rail or cargo-floor mounting without a MOLLE base.</dd>
  <dt><strong>What color options are available?</strong></dt>
  <dd>Available in black, coyote/tan, ranger green, and multicam to match your interior build.</dd>
</dl>

<h2>Safety & Trail Prep Accessories</h2>
<ul>
  <li><a href="/collections/roll-bar-fire-extinguisher-holder">Roll Bar Fire Extinguisher Holders</a></li>
  <li><a href="/collections/molle-accessories">MOLLE Accessories</a></li>
  <li><a href="/collections/jeep-wrangler-grab-handles">Grab Handles</a></li>
  <li><a href="/collections/jeep-wrangler-storage-bags-organizers">Storage Bags & Organizers</a></li>
  <li><a href="/collections/jeep-wrangler-jl-seat-covers">Jeep Wrangler JL Seat Covers</a></li>
...
<ul>
  ...
  'jeep-wrangler-storage-bags-organizers': `<p>Keep your Wrangler organized on trail and in town with Bartact's <strong>Jeep storage bags</strong> and organizers—hand-sewn in Gainesville, Georgia from 1000D Cordura nylon. Whether you need overhead organization, seat-back pouches, or cargo area management, Bartact makes storage solutions purpose-built for the Wrangler's odd angles and tight spaces.</p>
...
<dl>
  ...
  <dd>These bags are fitted for the Bronco (full-size). The Bronco Sport has different interior dimensions—check product listings for compatibility.</dd>
...
<ul>
  ...
  'jeep-wrangler-suspension-limit-straps': `<p><strong>Jeep limit straps</strong> protect your front and rear axle CV boots, brake lines, and fuel lines from over-extension damage at full droop. Bartact's suspension limit straps are hand-sewn in Gainesville, Georgia from 1000D Cordura webbing—far stronger and more abrasion-resistant than the cheap nylon straps that snap on a single high-droop flex.</p>

<p>When your Wrangler's suspension drops to full extension on the trail, the CV axles, brake hoses, and ABS lines are all under stress. OEM bump stops limit travel but don't protect against the shock load of dropping into a hole at speed. Limit straps absorb that energy gradually, preventing snap-extension that kills CVs and tears brake lines.</p>

<h2>Why Bartact Limit Straps?</h2>
<ul>
  <li><strong>1000D Cordura webbing:</strong> Rated for the dynamic shock loads of aggressive rock crawling and high-speed desert running—not just static weight.</li>
  <li><strong>Reinforced loop ends:</strong> Double-stitched, triple-bar-tacked attachment loops resist the point-load stress at mounting hardware.</li>
  <li><strong>Adjustable length:</strong> Fine-tune your suspension travel based on your lift height and axle clearance needs.</li>
  <li><strong>Made in USA:</strong> Every strap is sewn in Bartact's Gainesville, Georgia factory to the same standard as military load-bearing webbing.</li>
</ul>

<h2>Correct Sizing for Your Build</h2>
<p>Limit strap length depends on your lift height and the amount of travel you want to allow. Bartact provides a sizing guide on each product page—measure from mounting point to mounting point at full droop to find your correct strap length. Available for JK, JL, and Gladiator JT axle configurations.</p>

<h2>Frequently Asked Questions</h2>
<dl>
  <dt><strong>What lift height do I need limit straps?</strong></dt>
  <dd>Any lift over 2.5 inches puts additional stress on CV axles and brake lines at full droop. Limit straps are recommended for all lifted Wranglers.</dd>
  <dt><strong>How do I measure for the correct strap length?</strong></dt>
  <dd>With the vehicle at full suspension droop, measure the distance from the frame-mount hole to the axle-mount hole. Add your desired travel buffer (typically 1–2 inches).</dd>
  <dt><strong>Do limit straps affect on-road ride quality?</strong></dt>
  <dd>Properly sized limit straps only engage at or near full droop—they have zero effect on normal on-road suspension movement.</dd>
  <dt><strong>What hardware do I need for installation?</strong></dt>
  <dd>Mounting hardware (grade-8 bolts and washers) is included with Bartact limit straps. A basic socket set and torque wrench are all you need.</dd>
  <dt><strong>Can I use these on a Gladiator JT?</strong></dt>
  <dd>Yes. Bartact makes Gladiator-specific limit straps accounting for the JT's longer wheelbase and different axle geometry.</dd>
</dl>

<h2>Suspension & Trail Build Essentials</h2>
<ul>
  <li><a href="/collections/molle-accessories">MOLLE Accessories</a></li>
  <li><a href="/collections/winch-covers">Winch Covers</a></li>
  <li><a href="/collections/jeep-wrangler-storage-bags-organizers">Storage Bags & Organizers</a></li>
...
async function main() {
  ...
  for (const col of collections) {
    const html = contentMap[col.handle];
    if (!html) {
      console.log(`SKIP ${col.handle} — no content template`);
      continue;
    }
    ...
    const payload = { [key]: { id: col.id, body_html: html } };
    console.log(`Updating ${col.handle} (${col.id})...`);
    const res = await shopifyRequest('PUT', endpoint, payload);
    if (res.status === 200) {
      console.log(`  ✅ OK`);
      results.push({ handle: col.handle, status: 'updated' });
    } else {
      console.log(`  ❌ ${res.status}`, JSON.stringify(res.data).slice(0, 200));
  ...
  const fs = require('fs');
  fs.writeFileSync('/home/ubuntu/.openclaw/workspace/memory/bartact-expand-results.json', JSON.stringify({ date: new Date().toISOString(), results }, null, 2));
}
